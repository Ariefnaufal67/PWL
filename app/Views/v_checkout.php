...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="col-12">
            ...
            <select class="form-control" id="kelurahan" name="kelurahan" required="kelurahan"></select>
            <!-- <strong>select kelurahan</strong> -->
        </div>
        <div class="col-12">
            <label for="layanan" class="form-label">Layanan</label>
            <select class="form-control" id="layanan" name="layanan" required="layanan"></select>
